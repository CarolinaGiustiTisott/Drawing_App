...
import com.example.drawing_app.databinding.ActivityMainBinding
import com.example.drawing_app.databinding.DialogBrushSizeBinding
        ...
        withContext(Dispatchers.IO){
            if(mBitmap != null){
                try {
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString() + File.separator + "Drawing_App_" + System.currentTimeMillis() / 1000 + ".png")
